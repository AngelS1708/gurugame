        ...
        body: SafeArea(
          ...
          child: StreamBuilder<List<GamesRecord>>(
            stream: queryGamesRecord(
              queryBuilder: (gamesRecord) => gamesRecord.orderBy('titulo'),
            ),
            builder: (context, snapshot) {
              ...
              return Column(
                ...
                children:
                    List.generate(columnGamesRecordList.length, (columnIndex) {
                  final columnGamesRecord = columnGamesRecordList[columnIndex];
                  return Container(
                                  ...
                                  child: Padding(
                                    ...
                                    child: Row(
                                      ...
                                      children: [
                                        ...
                                        FFButtonWidget(
                                          onPressed: () async {
                                            await columnGamesRecord.reference
                                                .delete();
                                          },
                                          text: 'Eliminar',
